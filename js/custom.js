...
$(document).ready(function(){
   ...
   function validateName(elem) {
      const name = elem.val().trim();
      if (name.length < 3) {
        console.log('O campo de nome deve ter mais de 2 caracteres');
        elem.parent().find('.text-muted').show();
        elem.addClass('invalid');
        return false;
      } else {
    ...
    function validateEmail(elem) {
      ...
      if (!emailRegex.test(email)) {
        console.log('O campo de email deve conter um endereço de email válido');
        elem.parent().find('.text-muted').show();
        elem.addClass('invalid');
        return false;
      } else {
    ...
    function validateCPF(elem) {
      ...
      if (
        ...
        console.log('O campo de CPF deve conter um CPF válido');
        elem.parent().find('.text-muted').show();
        elem.addClass('invalid');
        return false;
      } else {
